...
- Configure release secrets:
  ...
  - `GITCODE_TOKEN` for optional GitCode Release synchronization after GitHub
    Release publication. The token must be able to create or update Releases
    and upload Release assets in the target GitCode repository.
